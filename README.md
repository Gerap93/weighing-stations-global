...
en Cloudflare Pages. Este despliegue **global** incluye los tres centros:
...
`data.json` y muestra solo los que existen. El mismo `index.html` sirve para los tres
despliegues (global, spain, dubai); lo único que cambia son los `data.json` incluidos.
